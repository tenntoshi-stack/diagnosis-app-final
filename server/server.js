...
// 各APIエンドポイント（以前の完成版と同じ）
app.get('/api/diagnoses', (req, res) => { db.all("SELECT * FROM diagnosis_sets", [], (err, rows) => res.json(rows || [])); });
